...
description: Download videos from your Whop classes and backup your hard work, save courses you've paid for, and enjoy offline
---
...
1. **Install** — Add SERP Whop Downloader to your browser from the [product page](https://serp.ly/whop-video-downloader), or download the latest version from [GitHub Releases](https://github.com/serpapps/whop-video-downloader/releases/latest) and install it from the product page or browser extension listing
...
**Step 1 — Install the extension.** Visit the extension store for your browser and add SERP Whop Downloader. Alternatively, download the latest release from [GitHub](https://github.com/serpapps/whop-video-downloader/releases/latest) and install it from the product page or browser extension listing in your browser's extension settings. The icon appears in your toolbar once installed.
...
This repository is distributed under the proprietary SERP Apps license in the [LICENSE](https://raw.githubusercontent.com/serpapps/whop-video-downloader/refs/heads/main/LICENSE) file. Review that file before copying, modifying, or redistributing any part of this project.
