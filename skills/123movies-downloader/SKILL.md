...
description: Download movies and TV shows from 123movies instantly without ads or popups
---
...
1. **Add the extension** — Install SERP 123Movies Downloader from your browser's extension store, or download the latest version from [GitHub Releases](https://github.com/serpapps/123movies-downloader/releases/latest) and install it from the product page or browser extension listing
...
This repository is distributed under the proprietary SERP Apps license in the [LICENSE](https://raw.githubusercontent.com/serpapps/123movies-downloader/refs/heads/main/LICENSE) file. Review that file before copying, modifying, or redistributing any part of this project.
